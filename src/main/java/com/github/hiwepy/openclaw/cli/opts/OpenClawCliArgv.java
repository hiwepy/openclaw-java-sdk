 ...
 * <p>供各 {@link com.github.hiwepy.openclaw.cli.args.CliSubArgs} 实现类在
 * {@link com.github.hiwepy.openclaw.cli.args.CliSubArgs#toSubcommandArguments()} 中复用，避免重复拼接逻辑。</p>
 */
final class OpenClawCliArgv {
    ...
    /**
     * 将「逃生舱」额外 token 全部追加到末尾（{@link com.github.hiwepy.openclaw.cli.opts} 各 Builder 的 {@code extra}）。
     *
     * @param out   目标参数列表
