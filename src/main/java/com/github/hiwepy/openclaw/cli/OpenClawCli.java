...
import com.github.hiwepy.openclaw.cli.opts.*;
...
/**
 * 官方 CLI 顶层命令封装；每个方法接收 {@code com.github.hiwepy.openclaw.cli.opts} 包中的 {@link CliSubArgs} 实现（如 {@link SetupOptions}、{@link AgentOptions}），
